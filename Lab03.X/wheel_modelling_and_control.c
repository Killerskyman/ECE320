...
#define A2D_LOW 0 // lowest reading fron the pot, subtract this to make it zero
#define A2D_HIGH 1023 // Maximum reading from the pot once the zero is set
...
int main ( void )
{
  ...
  double A[4] = {1.0, -1.1619, 0.6959, -0.1378}, B[4] = {0.0495, 0.1486, 0.1486, 0.0495}; 
  int Nr =4, Ny=4;
  double AD_scale = 1.0;
